...
class ViewController4: UIViewController {
    ...
    let imgeview = UIImageView(image: UIImage(named: "Image-3"))
    
    let lbl : UILabel = {
        let lbl = UILabel()
        lbl.translatesAutoresizingMaskIntoConstraints = false
        lbl.text = "Congratulations on your successful registration"
...
//        buton.titleLabel?.font = UIFont.systemFont(ofSize: 25, weight: .bold)
    ...
    override func viewDidLoad() {
        ...
        imge.image = UIImage(named: "4c65a64b6b2d38b0d3813b815c9db912")
        view.insertSubview(imge, at: 0)
        Button.addTarget(self, action: #selector(MainViewconntroll2), for: .touchUpInside)
